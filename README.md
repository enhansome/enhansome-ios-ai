...
* [SwiftUI Pro](https://github.com/twostraws/SwiftUI-Agent-Skill) ⭐ 4,619 | 🐛 11 | 📅 2026-04-20 - Modern APIs, accessibility, data flow, navigation, and performance.
* [SwiftUI Performance Audit](https://github.com/Dimillian/Skills/tree/main/swiftui-performance-audit) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - Diagnose slow rendering, janky scrolling, excessive view updates, and layout thrash.
* [SwiftUI View Refactor](https://github.com/Dimillian/Skills/tree/main/swiftui-view-refactor) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - Consistent view structure, MV patterns, @Observable usage, and dependency injection.
* [SwiftUI UI Patterns](https://github.com/Dimillian/Skills/tree/main/swiftui-ui-patterns) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - Component references for TabView, NavigationStack, Sheets, and view composition.
* [SwiftUI Liquid Glass](https://github.com/Dimillian/Skills/tree/main/swiftui-liquid-glass) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - iOS 26+ Liquid Glass API with `glassEffect`, `GlassEffectContainer`, and availability fallbacks.
* [SwiftUI Expert](https://github.com/AvdLee/SwiftUI-Agent-Skill) ⭐ 3,464 | 🐛 3 | 🌐 Python | 📅 2026-08-12 - State management, view composition, performance, and iOS 26+ Liquid Glass.

### Swift Concurrency

* [Swift Concurrency Expert](https://github.com/Dimillian/Skills/tree/main/swift-concurrency-expert) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - Swift 6.2+ actor isolation, data-race safety, and minimal-change fixes for compiler errors.
* [Swift Concurrency](https://github.com/AvdLee/Swift-Concurrency-Agent-Skill) ⭐ 1,632 | 🐛 6 | 📅 2026-08-12 - Async/await, actors, Sendable, and strict concurrency for Swift 6.
...
* [iOS Debugger Agent](https://github.com/Dimillian/Skills/tree/main/ios-debugger-agent) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - Build, run, and debug iOS apps on simulators via XcodeBuildMCP.
...
* [App Store Changelog](https://github.com/Dimillian/Skills/tree/main/app-store-changelog) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - Generate App Store release notes from Git history.
* [GH Issue Fix Flow](https://github.com/Dimillian/Skills/tree/main/github) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - End-to-end GitHub issue resolution with read, fix, build, test, and push.
* [macOS SwiftPM Packaging](https://github.com/Dimillian/Skills/tree/main/macos-spm-app-packaging) ⭐ 3,928 | 🐛 11 | 🌐 Shell | 📅 2026-03-29 - Scaffold, build, and package SwiftPM macOS apps without Xcode.
